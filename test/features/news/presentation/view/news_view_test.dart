...
void main() {
  ...
  testWidgets('News view has essential widgets', (WidgetTester tester) async {
  ...
  testWidgets('Shadow effect when user presses the widget',
  ...
  testWidgets('Displays news list when NewsOverviewLoaded state is received',
      (WidgetTester tester) async {
    // Build the LoginView widget
    await tester.pumpWidget(
      MaterialApp(
