...
void main() {
  ...
  testWidgets('Login view has essential widgets', (WidgetTester tester) async {
  ...
  testWidgets('User can enter text in username and password fields',
  ...
  testWidgets('Login button click causes an animation',
      (WidgetTester tester) async {
    // Build the LoginView widget
    await tester.pumpWidget(
      MaterialApp(
  ...
  testWidgets('Please enter message when textfield empty',
      (WidgetTester tester) async {
    // Build the LoginView widget
    await tester.pumpWidget(
      MaterialApp(
